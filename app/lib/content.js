      ...
      clusters: [
        {
          ...
          skills: [
            ...
            { name: "Fastify",                   weight: 4, since: 2018, frequency: "weekly",     en: "The Node.js web framework. Fast, schema-based, low overhead. Powers most of my API servers.",                                                                                                                       es: "El framework web para Node.js. Rápido, schema-based, ligero. Motor de la mayoría de mis API servers.",                                                                            bridges: ["RAG & Vector DBs"] },
            ...
            { name: "HTML5 & CSS3",              weight: 4, since: 2003, frequency: "daily",      en: "Semantic markup and modern CSS — Grid, Flex, custom properties, container queries. No frameworks when none are needed.",                                                                                       es: "Markup semántico y CSS moderno — Grid, Flex, custom properties, container queries. Sin frameworks cuando no hacen falta.",                                                       bridges: [] },
            { name: "React",                     weight: 4, since: 2016, frequency: "daily",      en: "Component-driven UI. Hooks, state management, server components. The default for new SPAs.",                                                                                                                          es: "UI dirigida por componentes. Hooks, state, server components. El default para SPAs nuevas.",                                                                                          bridges: [] },
            { name: "Vue",                       weight: 3, since: 2017, frequency: "weekly",     en: "Composition API, SFCs. Lighter footprint than React for many use cases — and Nuxt when SSR matters.",                                                                                                                es: "Composition API, SFCs. Más liviano que React en muchos casos — y Nuxt cuando el SSR importa.",                                                                                  bridges: [] },
        ...
        },
        {
          ...
          skills: [
            { name: "Debian/Ubuntu GNU/Linux",    weight: 5, since: 2003, frequency: "daily",   en: "Default server OS. apt, systemd, the usual. First love, still.",                                                                                                                                                       es: "OS servidor por defecto. apt, systemd, lo de siempre. Primer amor, aún.",                                                                                                            bridges: ["High-Availability Architecture", "Linux System Hardening"] },
            ...
            { name: "PostgreSQL",                 weight: 5, since: 2008, frequency: "daily",   en: "Primary database. JSONB, full-text search, pgvector — the most versatile datastore I know.",                                                                                                                            es: "Base de datos primaria. JSONB, full-text search, pgvector — el datastore más versátil que conozco.",                                                                       bridges: [] },
            ...
            { name: "Memcached",                  weight: 3, since: 2010, frequency: "monthly", en: "When you need a fast cache, this is the boring answer. Battle-tested for fifteen years.",                                                                                                                                es: "Cuando necesitás un cache rápido, esta es la respuesta aburrida. Battle-tested por quince años.",                                                                            bridges: [] },
            { name: "TCP/IP & VPN",               weight: 4, since: 2006, frequency: "monthly", en: "Network fundamentals. WireGuard, OpenVPN, IPsec. ISP-level work in another life.",                                                                                                                                     es: "Fundamentos de red. WireGuard, OpenVPN, IPsec. Trabajo de ISP en otra vida.",                                                                                                    bridges: ["Network Engineering (PtP/PtmP)"] },
            { name: "DNS & DHCP",                 weight: 3, since: 2006, frequency: "monthly", en: "BIND, dnsmasq, Unbound. Core network services that nobody notices when they work.",                                                                                                                                      es: "BIND, dnsmasq, Unbound. Servicios de red clave que nadie nota cuando funcionan.",                                                                                              bridges: [] },
        ...
        },
        {
          ...
          skills: [
            ...
            { name: "Network Engineering (PtP/PtmP)",   weight: 4, since: 2008, frequency: "occasional", en: "ISP-level networking. Wireless backhauls, PtP and PtmP links, network ops from another career.",                                                                                                                      es: "Networking a nivel ISP. Backhauls inalámbricos, enlaces PtP y PtmP, network ops de otra carrera.",                                                                          bridges: ["DNS & DHCP"] },
            { name: "Linux System Hardening",          weight: 5, since: 2010, frequency: "weekly",  en: "CIS benchmarks, SELinux/AppArmor, minimal attack surface. Default posture for anything I deploy.",                                                                                                                       es: "CIS benchmarks, SELinux/AppArmor, mínima superficie de ataque. Postura por defecto para todo lo que despliego.",                                                          bridges: [] },
            ...
            { name: "Cost-Saving Infrastructure Design", weight: 4, since: 2015, frequency: "weekly",  en: "Right-sizing, reserved capacity, self-hosted alternatives. The unsexy work that pays the bills.",                                                                                                                          es: "Right-sizing, capacidad reservada, alternativas self-hosted. El trabajo poco sexy que paga las cuentas.",                                                                   bridges: ["Proxmox & KVM", "Amazon AWS (EC2, S3, RDS)"] },
          ],
        },
      ],
    },
