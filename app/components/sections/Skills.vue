      ...
      <div class="grid md:grid-cols-3 gap-12">
        <div v-for="(pillar, index) in competenciesContent.pillars" :key="index">
          ...
          <div class="flex flex-wrap justify-center">
            <div v-for="(skill, skillIndex) in pillar.skills" :key="skillIndex" class="bg-primary text-dark rounded-full px-4 py-2 text-sm font-semibold m-2 flex items-center">
